...
export function mapBalanceRecord(record: YFinanceRecord) {
  return {
    ...
    shortTermDebt: pickNum(record, 'Current Debt', 'Current Debt And Capital Lease Obligation') ?? null,
    totalCurrentLiabilities: pickNum(record, 'Current Liabilities', 'totalCurrentLiabilities') ?? null,
    longTermDebt: pickNum(record, 'Long Term Debt', 'Long Term Debt And Capital Lease Obligation', 'longTermDebt') ?? null,
