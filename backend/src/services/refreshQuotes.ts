  ...
  for (const c of companies) {
    try {
      ...
      const stockData = {
        ...
        targetHighPrice: info?.targetHighPrice ?? existing?.targetHighPrice ?? null,
        targetLowPrice: info?.targetLowPrice ?? existing?.targetLowPrice ?? null,
        recommendationKey: info?.recommendationKey ?? existing?.recommendationKey ?? null,
        recommendationMean: info?.recommendationMean ?? existing?.recommendationMean ?? null,
