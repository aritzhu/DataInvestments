...
const SPAIN: EuropeanTicker[] = [
  { ticker: "ACX.MC", name: "Acerinox SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Basic Materials" },
  { ticker: "ACS.MC", name: "ACS Actividades de Construcción y Servicios SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "AENA.MC", name: "Aena SME SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "AMS.MC", name: "Amadeus IT Group SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Technology" },
  { ticker: "ANA.MC", name: "Acciona SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "ANE.MC", name: "Corporación Acciona Energías Renovables SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  ...
  { ticker: "BKT.MC", name: "Bankinter SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
  { ticker: "CABK.MC", name: "CaixaBank SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
  { ticker: "CLNX.MC", name: "Cellnex Telecom SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Communication Services" },
  { ticker: "COL.MC", name: "Inmobiliaria Colonial SOCIMI SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Real Estate" },
  { ticker: "ELE.MC", name: "Endesa SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  { ticker: "ENG.MC", name: "Enagás SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  { ticker: "FDR.MC", name: "Fluidra SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "FER.MC", name: "Ferrovial SE", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  ...
  { ticker: "IDR.MC", name: "Indra Sistemas SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "ITX.MC", name: "Industria de Diseño Textil SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Consumer Cyclical" },
  { ticker: "LOG.MC", name: "Logista Integral SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "MAP.MC", name: "Mapfre SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
  { ticker: "MRL.MC", name: "Merlin Properties SOCIMI SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Real Estate" },
  { ticker: "MTS.MC", name: "ArcelorMittal SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Basic Materials" },
  { ticker: "NTGY.MC", name: "Naturgy Energy Group SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  { ticker: "PUIG.MC", name: "Puig Brands SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Consumer Cyclical" },
  { ticker: "RED.MC", name: "Redeia Corporación SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  { ticker: "REP.MC", name: "Repsol SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Energy" },
  { ticker: "ROVI.MC", name: "Laboratorios Farmacéuticos Rovi SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Healthcare" },
  { ticker: "SAB.MC", name: "Banco de Sabadell SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
  { ticker: "SAN.MC", name: "Banco Santander SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
  { ticker: "SCYR.MC", name: "Sacyr SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Industrials" },
  { ticker: "SLR.MC", name: "Solaria Energía y Medio Ambiente SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Utilities" },
  { ticker: "TEF.MC", name: "Telefónica SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Communication Services" },
  { ticker: "UNI.MC", name: "Unicaja Banco SA", country: "España", countryCode: "ES", exchange: "BME", sector: "Financial Services" },
];
