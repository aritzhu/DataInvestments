...
export const EXISTING_FIELDS: FieldCatalogEntry[] = [
  ...
  },
  {
    ...
    category: 'income_statement',
    source: 'sec',
    xbrlTags: ['OperatingExpenses', 'OperatingCostsAndExpenses', 'CostsAndExpenses'],
    defaultValue: 0,
  ...
  },
  {
    ...
    category: 'income_statement',
    source: 'sec',
    xbrlTags: ['SellingGeneralAndAdministrativeExpense', 'SellingAndAdministrativeExpense', 'SellingAndMarketingExpense'],
    defaultValue: 0,
  ...
  },
  {
    ...
    category: 'income_statement',
    source: 'sec',
    xbrlTags: ['InterestExpense', 'InterestAndDebtExpense', 'InterestExpenseNonoperating'],
    defaultValue: 0,
  ...
  },
  {
    ...
    category: 'balance_sheet_assets',
    source: 'sec',
    xbrlTags: ['InventoryNet', 'Inventory', 'InventoryCurrent', 'AirlineRelatedInventoryNet'],
    defaultValue: null,
